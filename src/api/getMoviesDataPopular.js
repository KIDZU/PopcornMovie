...
export const getMoviesDataPopular = async () => {
    const { data } = await axios(
      `https://api.kinopoisk.dev/v1.4/movie?page=1&limit=4&${selectedFieldsString}&${notNullFieldsString}&sortField=rating.imdb&sortType=-1`,
      {

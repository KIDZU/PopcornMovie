...
export const getMoviesDataById = async (moviesId) => {
  const idParams = createStringQuery(moviesId, 'id')
    const { data } = await axios(
      `https://api.kinopoisk.dev/v1.4/movie?${idParams}&${selectedFieldsString}`,
      {
